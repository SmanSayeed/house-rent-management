...
/**
 * Middleware for validating flat data.
 *
...
const validate = (req, res, next) => {
    // Run the validations
    Promise.all(validateFlat.map(validation => validation.run(req))).then(() => {
...
module.exports = { validateFlat, validate };
